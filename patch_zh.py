...
def get_workbench_replacements():
    ...
    return [
        ...
        # ============================================================
        # 11. v1.41+ 新增 label 翻译（从实际安装文件扫描）
        # ============================================================
        # Settings 面板 - 新增设置项
        ('label:"Strict Mode"', 'label:"严格模式"'),
        ('label:"Auto-Expand Changes Overview"', 'label:"自动展开更改概览"'),
        ('label:"Verbose agent chat"', 'label:"详细 Agent 对话"'),
        ('label:"Enable Sounds for Agent"', 'label:"Agent 声音提示"'),
        ('label:"Enable Browser Tools"', 'label:"启用浏览器工具"'),
        ('label:"Chrome Binary Path"', 'label:"Chrome 可执行文件路径"'),
        ('label:"Browser User Profile Path"', 'label:"浏览器用户配置路径"'),
        ('label:"Browser CDP Port"', 'label:"浏览器 CDP 端口"'),
        ('label:"Browser Javascript Execution Policy"', 'label:"浏览器 JavaScript 执行策略"'),
        ('label:"Browser URL Allowlist"', 'label:"浏览器 URL 允许列表"'),
        ('label:"Agent Non-Workspace File Access"', 'label:"Agent 非工作区文件访问"'),
        ('label:"Agent Host Address"', 'label:"Agent 主机地址"'),
        ('label:"Allow List Terminal Commands"', 'label:"终端命令允许列表"'),
        ('label:"Deny List Terminal Commands"', 'label:"终端命令拒绝列表"'),
        ('label:"Enable Terminal Sandbox"', 'label:"启用终端沙盒"'),
        ('label:"Enable Remote Control"', 'label:"启用远程控制"'),
        ('label:"Enable Overages"', 'label:"启用超额用量"'),
        ('label:"Sandbox Allow Network"', 'label:"沙盒允许网络"'),
        ('label:"Include Jetski Default Customizations"', 'label:"包含 Jetski 默认自定义项"'),
        # Settings 面板 - 侧边栏分类
        ('label:"Knowledge"', 'label:"知识库"'),
        ('label:"Rules"', 'label:"规则"'),
        ('label:"Workflows"', 'label:"工作流"'),
        ('label:"MCP Servers"', 'label:"MCP 服务器"'),
        ('label:"Screen Recording"', 'label:"屏幕录制"'),
        ...
        # 对话操作
        ('label:"Archive this conversation"', 'label:"归档此对话"'),
        ('label:"Archive / Restore"', 'label:"归档/恢复"'),
        ('label:"Delete Conversation"', 'label:"删除对话"'),
        ('label:"Copy conversation markdown"', 'label:"复制对话 Markdown"'),
        ('label:"Conversation History"', 'label:"对话历史"'),
        ('label:"Open Conversation History"', 'label:"打开对话历史"'),
        ('label:"Open Conversation"', 'label:"打开对话"'),
        ('label:"Mark as Read"', 'label:"标记为已读"'),
        ('label:"Mark as Unread"', 'label:"标记为未读"'),
        ('label:"Ask Agent for Help"', 'label:"向 Agent 寻求帮助"'),
        # Mention（提及）
        ('label:"Mention"', 'label:"提及"'),
        ('label:"Mention Selection"', 'label:"提及选中内容"'),
        ('label:"Mentions"', 'label:"提及项"'),
        # Diff 操作
        ('label:"Reject hunk"', 'label:"拒绝代码块"'),
        ('label:"Reject Step"', 'label:"拒绝此步骤"'),
        ('label:"Accept Step"', 'label:"接受此步骤"'),
        # Toggle 操作
        ('label:"Toggle Dev View"', 'label:"切换开发视图"'),
        ('label:"Toggle Developer Tools"', 'label:"切换开发工具"'),
        ('label:"Toggle Fullscreen"', 'label:"切换全屏"'),
        ('label:"Toggle Voice Recording"', 'label:"切换语音录制"'),
        ('label:"Toggle Environment Selector"', 'label:"切换环境选择器"'),
        ('label:"Toggle Project Selector"', 'label:"切换项目选择器"'),
        # 运行/执行
        ('label:"Run (unsandboxed)"', 'label:"运行（不沙盒）"'),
        ('label:"Allow in Conversation"', 'label:"在对话中允许"'),
        # 账号/购买
        ('label:"Purchase Credits"', 'label:"购买积分"'),
        ('label:"See Plans"', 'label:"查看方案"'),
        ('label:"Enable Demo Mode (Beta)"', 'label:"启用演示模式 (Beta)"'),
        ('label:"Provide feedback"', 'label:"提供反馈"'),
        ('label:"Start fresh"', 'label:"重新开始"'),
        ('label:"Check for Updates"', 'label:"检查更新"'),
        # 导入/配置
        ('label:"Import from VS Code"', 'label:"从 VS Code 导入"'),
        ('label:"Import from Cursor"', 'label:"从 Cursor 导入"'),
        ('label:"Import from Windsurf"', 'label:"从 Windsurf 导入"'),
        ('label:"Import from Cider"', 'label:"从 Cider 导入"'),
        ('label:"Use theme to be imported with settings"', 'label:"导入设置时使用主题"'),
        # 其他常用 label
        ('label:"Scheduled Tasks"', 'label:"计划任务"'),
        ('label:"New Agent Script"', 'label:"新建 Agent 脚本"'),
        ('label:"Restart Main Language Server"', 'label:"重启主语言服务器"'),

        # ============================================================
        # 12. v1.41+ 新增 children 翻译
        # ============================================================
        # 对话历史 / 时间分组
        ('children:"Today"', 'children:"今天"'),
        ('children:"Yesterday"', 'children:"昨天"'),
        ('children:"Past Conversations"', 'children:"过去的对话"'),
        ('children:"Pinned Conversations"', 'children:"已置顶对话"'),
        ('children:"Sort Conversations"', 'children:"排序对话"'),
        ('children:"No conversations yet"', 'children:"暂无对话"'),
        ('children:"Delete Conversation"', 'children:"删除对话"'),
        # 模型选择器
        ('children:"Experimental"', 'children:"实验性"'),
        ('children:"No Model Selected"', 'children:"未选择模型"'),
        ('children:"No models available"', 'children:"暂无可用模型"'),
        ('children:"Models Tab"', 'children:"模型标签"'),
        # 空状态提示
        ('children:"No background tasks"', 'children:"无后台任务"'),
        ('children:"No conversations yet"', 'children:"暂无对话"'),
        ('children:"No artifacts generated."', 'children:"未生成产物。"'),
        ('children:"No changes to review"', 'children:"无需审查的更改"'),
        ('children:"No internet. Agent features may not work."', 'children:"无网络连接，Agent 功能可能无法使用。"'),
        ('children:"No items found"', 'children:"未找到项目"'),
        # 设置 / 安全
        ('children:"Execute Javascript policy"', 'children:"JavaScript 执行策略"'),
        ('children:"Review Changes"', 'children:"审查更改"'),
        ('children:"Security Notice & Data Use"', 'children:"安全说明与数据使用"'),
        # 知识库 / 技能 / 规则
        ('children:"Knowledge feature is not available."', 'children:"知识库功能不可用。"'),
        ('children:"Rules help guide the behavior of Agent."', 'children:"规则有助于引导 Agent 的行为。"'),
        ('children:"Skills are instructions that extend what Agent can do."', 'children:"技能是扩展 Agent 功能的指令。"'),
        ('children:"Skills"', 'children:"技能"'),
        # 其他状态/操作
        ('children:"Thinking..."', 'children:"思考中..."'),
        ('children:"Proceed"', 'children:"继续"'),
        ('children:"Proceed Anyways"', 'children:"无论如何继续"'),
        ('children:"Skip"', 'children:"跳过"'),
        ('children:"Skipped"', 'children:"已跳过"'),
        ('children:"Save"', 'children:"保存"'),
        ('children:"Rename"', 'children:"重命名"'),
        ('children:"Reset"', 'children:"重置"'),
        ('children:"Restart"', 'children:"重启"'),
        ('children:"Refresh"', 'children:"刷新"'),
        ('children:"Refresh rules"', 'children:"刷新规则"'),
        ('children:"Refresh workflows"', 'children:"刷新工作流"'),
        ('children:"Refresh skills"', 'children:"刷新技能"'),
        ('children:"Get Logs"', 'children:"获取日志"'),
        ('children:"View Logs"', 'children:"查看日志"'),
        ('children:"View customizations"', 'children:"查看自定义"'),
        ('children:"View documentation"', 'children:"查看文档"'),
        ('children:"View MCP settings"', 'children:"查看 MCP 设置"'),
        ('children:"View Debug"', 'children:"查看调试"'),
        ('children:"View plans"', 'children:"查看计划"'),
        ('children:"Send Feedback"', 'children:"发送反馈"'),
        ('children:"See all"', 'children:"查看全部"'),
        ('children:"Show more"', 'children:"显示更多"'),
        ('children:"Open Editor"', 'children:"打开编辑器"'),
        ('children:"History"', 'children:"历史"'),
        ('children:"Environment"', 'children:"环境"'),
        ('children:"Extensions"', 'children:"扩展"'),
        ('children:"Keybindings"', 'children:"键盘快捷键"'),
        ('children:"Input"', 'children:"输入"'),
        ('children:"Output"', 'children:"输出"'),
        ('children:"Preview"', 'children:"预览"'),
        ('children:"Filter"', 'children:"筛选"'),
        ('children:"Install"', 'children:"安装"'),
        ('children:"Expand"', 'children:"展开"'),
        ('children:"Launch"', 'children:"启动"'),
        ...
        # 工具/MCP
        ('children:"MCP Servers Disabled"', 'children:"MCP 服务器已禁用"'),
        ('children:"MCP Error"', 'children:"MCP 错误"'),
        ('children:"MCP Store"', 'children:"MCP 商店"'),
        ('children:"Manage MCP Servers"', 'children:"管理 MCP 服务器"'),
        ('children:"Your administrator has disabled MCP servers."', 'children:"您的管理员已禁用 MCP 服务器。"'),
        # 占位文本
        ('placeholder:"Search conversations..."', 'placeholder:"搜索对话..."'),
        ('placeholder:"Ask Agent anything..."', 'placeholder:"向 Agent 提问..."'),
        ('placeholder:"Search files..."', 'placeholder:"搜索文件..."'),
        # title 属性补充
        ('title:"Reject hunk"', 'title:"拒绝代码块"'),
        ('title:"Screen Recording"', 'title:"屏幕录制"'),
        ('title:"Conversation History"', 'title:"对话历史"'),
        ('title:"Knowledge"', 'title:"知识库"'),
        ('title:"Rules"', 'title:"规则"'),
        ('title:"Workflows"', 'title:"工作流"'),
